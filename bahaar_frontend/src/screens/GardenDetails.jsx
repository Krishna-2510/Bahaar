...
export const GardenDetails = () => {
    ...
    return (
        <>
            ...
            {plants.length === 0 && !addingNewPlant && <GardenContainer>
            ...
            <PlantContainer>
                {
                    plants.map((plant) => (
                        <PlantCard plant={plant} edit={false} gardenId={garden.id} plantAdded={setAddingNewPlant} refreshPlants={setRefreshPlants} setNotification={setNotificationDetails}></PlantCard>
                    ))
                }
                {addingNewPlant && <PlantCard edit={true} gardenId={garden.id} plantAdded={setAddingNewPlant} refreshPlants={setRefreshPlants} setNotification={setNotificationDetails}></PlantCard>}
